...
[![Tests](https://img.shields.io/badge/tests-287%20passing%20(as%20of%202026--03--04)-success.svg)](https://github.com)
...
本番環境で動作中のデモをご覧いただけます：

- **フロントエンド**: https://simple-diary-frontend.onrender.com
- **バックエンドAPI**: https://simple-diary-backend.onrender.com

> **注意**: 無料プランのため、15分間アクセスがないとスリープします。初回アクセス時は起動に30-60秒程度かかる場合があります。
...
- ✅ **高品質**: 287テスト、99.4%カバレッジ達成（2026-03-04時点）
- 🚀 **高速**: ローカルSQLiteで高速動作
...
### 3. 日記を編集する
1. エントリー詳細ページで "Edit" ボタンをクリック
2. 内容を変更して "Save" ボタンをクリック

### 4. 日記を削除する
1. エントリー詳細ページで "Delete" ボタンをクリック
...
| GET | /api/entries?year=YYYY&month=MM | 月別エントリー取得 |
